          ...
          <div class="group">
            ...
            <div class="site-footer__col-two-three-group">
              <div class="site-footer__col-two">
                ...
                <h4 class="site-footer__heading">Stanowisko</h4>
                <nav class="nav-list">
                  <ul>
                  <?php wp_nav_menu(array(
                ...
                <h4 class="site-footer__heading">Typ rośliny</h4>
                <nav class="nav-list">
                  <ul>
                  <?php wp_nav_menu(array(
            ...
            <div class="site-footer__col-four">
              ...
              <p class="site-footer__contact-item">
                ...
                <a href="https://github.com/Ilona8895" target="_blank" class="site-footer__link">Ilona8895</a>
              </p>
            </div>
          </div>
        </div>
